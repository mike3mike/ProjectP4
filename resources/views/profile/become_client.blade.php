    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('submit_become_client') }}">
                        @csrf

                        <div class="form-group row">
                            <label for="company_name" class="col-md-4 col-form-label text-md-right">{{ __('Bedrijfsnaam') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="contact_person" class="col-md-4 col-form-label text-md-right">{{ __('Contactpersoon') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="billing_email" class="col-md-4 col-form-label text-md-right">{{ __('Factuur e-mail') }}</label>
